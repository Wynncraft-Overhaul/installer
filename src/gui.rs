                                            ...
                                            label { class: "tooltip",
                                                ...
                                                match feat.description {
                                                    Some(ref desc) => rsx!(span {
                                                        class: "tooltiptext",
                                                        style: "position: absolute; z-index: 10; background: rgba(0, 0, 0, 0.8); color: white; padding: 5px; border-radius: 5px; white-space: normal; max-width: 200px; word-wrap: break-word; overflow: hidden; text-overflow: ellipsis; right: 0; top: -5px; margin-right: 10px;",
                                                        "{desc}",
                                                    }),
                                                    None => rsx!("")
                                                }
